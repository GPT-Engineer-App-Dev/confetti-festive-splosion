...
**Project**: confetti-festive-splosion 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a fun confetti app 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/confetti-festive-splosion.git
cd confetti-festive-splosion
npm i
